...
export default function AssociateKidsDesignerProject() {
  return (
    <section id="page">
      <Head>
        <title>
          ASSOCIATE KIDS DESIGNER PROJECT &mdash; Lindsey Carrillo Design
          Portfolio
        </title>
        <meta
          property="og:title"
          content="ASSOCIATE KIDS DESIGNER PROJECT &mdash; Lindsey Carrillo Design Portfolio"
        />
        ...
        <meta
          ...
          content="ASSOCIATE KIDS DESIGNER PROJECT — Lindsey Carrillo Design Portfolio"
        />
        <meta name="twitter:url" content="/associate-kids-designer-project" />
      </Head>
      <CustomPage
        imageList={[
          {
